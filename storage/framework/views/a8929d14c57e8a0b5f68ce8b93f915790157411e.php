    ...
    <div class="larry-personal-body clearfix">
        <form class="layui-form col-lg-5">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="secret" autocomplete="off" class="layui-input" value="<?php echo e($admin_user['secret']); ?>" style="width: 50%;float: left;" disabled>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <img src="<?php echo e($admin_user['qrcod_url']); ?>" width="150px">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="google_verify" lay-filter="google_verify">
                        <option value="1" <?php if(isset($admin_user) && $admin_user['google_verify'] == 1): ?> selected <?php endif; ?>>开启</option>
                        <option value="0" <?php if(isset($admin_user) && $admin_user['google_verify'] == 0): ?> selected <?php endif; ?>>关闭</option>
                    </select>
                </div>
            </div>
            <input id="user_id" type="hidden" name="id" value="<?php echo e($admin_user['id']); ?>">
            <div class="layui-form-item">
                <div class="layui-input-block">
