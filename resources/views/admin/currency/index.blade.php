        ...
        layui.use(['table','form'], function(){
            ...
            table.render({
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'is_lever', title: '合约交易', minWidth:100, templet: '#lever'}
                    // ,{field: 'is_micro', title: '期权交易', minWidth: 90, templet: '#micro'}
                    ,{field: 'is_match', title: '币币交易', minWidth:100, templet: '#match'}
                    // ,{field: 'is_transfer', title: '币币划转', minWidth: 110, templet: '#is_transfer'}
                    ,{field: 'floating', title: '涨幅金额', minWidth:160}
                    ,{field: 'duration', title: '涨幅时间', minWidth:100}
                    ,{field: 'tickInterval', title: '涨幅时间间隔', minWidth:100}
