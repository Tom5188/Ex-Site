...
<script type="text/html" id="barDemo">
    @{{d.status==1 ? '<a class="layui-btn layui-btn-xs layui-btn-warm" lay-event="edit"><i class="layui-icon layui-icon-edit"></i> 编辑</a>' : '' }}
</script>
        ...
        layui.use(['element', 'form', 'layer', 'table', 'laydate'], function() {
            ...
            var data_table =   table.render({
                ...
                cols: [[
                    ...
                    ,{field: 'id', title: '订单ID', minWidth: 100}
                    ,{field: 'user_id', title: '用户账号', minWidth: 130, sort: true, totalRowText: '小计'}
