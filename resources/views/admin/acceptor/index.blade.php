        ...
        @section('scripts')
            <script>
                ...
                layui.use(['table','form'], function(){
                    ...
                    table.render({
                        elem: '#demo'
                        ,url: '{{url('admin/acceptor_list')}}' //数据接口
                        ,page: true //开启分页
                        ,id:'mobileSearch'
                        ,cols: [[ //表头
                            {field: 'id', title: 'ID', minWidth:80, sort: true}
                            ,{field: 'account_number', title: '用户名', minWidth:80}
                            ,{field: 'name', title: '名称', minWidth:80}
                            ,{field: 'recharge_amount', title: '充值额度', minWidth:80}
                    ...
                    table.on('tool(test)', function(obj){
                        ...
                        if(obj.event === 'del'){
                            ...
                            layer_show('编辑承兑商','{{url('admin/acceptor_add')}}?id='+data.id);
