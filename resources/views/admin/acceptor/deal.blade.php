...
@section('scripts')
    <script>
        ...
        layui.use(['table','form'], function(){
            ...
            table.render({
                elem: '#demo'
                ,url: '{{url('admin/acceptor_dealList')}}' //数据接口
                ,page: true //开启分页
                ,id:'mobileSearch'
                ,cols: [[ //表头
                    {field: 'id', title: 'ID', minWidth:80, sort: true}
                    ,{field: 'account_number', title: '用户名', minWidth:100}
                    ,{field: 'acceptor_name', title: '承兑商名称', minWidth:100}
                    ,{field: 'type_name', title: '交易类型', minWidth:100}
                    ...
                    ,{field: 'create_time', title: '提交时间', minWidth:180}
