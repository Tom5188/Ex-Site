    ...
    layui.use(['table', 'layer', 'form', 'laydate'], function() {
        ...
        var data_table = table.render({
            ...
            ,cols: [[
                ...
                ,{field: 'account_number', title: '用户', minWidth: 120, totalRowText: '小计:'}
//                ,{field: 'scene_name', title: '奖励场景', minWidth: 140}
//                ,{field: 'reward_type', title: '奖励类型', minWidth: 90, hide: true}
                ,{field: 'value', title: '亏返数量', minWidth: 110, totalRow: true, templet: '#reward_qty'}
                ,{field: 'info', title: '亏返说明', minWidth: 400}
//                ,{field: 'from_user_name', title: '触发用户', minWidth: 120}
                ,{field: 'created_time', title: '亏返时间', minWidth: 170}
            ]],
