...
return array(
    ...
    '您有正在进行中的杆杠交易,不能进行此操作' => '您有正在進行中的槓桿交易，無法執行此操作',
    '钱包不存在' => '錢包不存在',
    '划转成功' => '劃轉成功',
    '币种不存在' => '幣種不存在',
    ...
    '类型错误' => '類型錯誤',
    '钱包未找到' => '錢包未找到',
    '数量不能小于等于0' => '數量不能小於或等於0',
    '价格不能小于等于0' => '價格不能小於或等於0',
    '参数错误哦' => '參數錯誤',
    '数量不足' => '數量不足',
    '操作成功' => '操作成功',
    '真实姓名必须填写' => '必須填寫真實姓名',
    '收款信息至少选填一项' => '收款信息至少填寫一項',
    '保存成功' => '保存成功',
    '密码错误' => '密碼錯誤',
    '当前行情小于等于零!' => '當前行情小於或等於零！',
    '参数错误!' => '參數錯誤！',
    ...
    '手势密码添加成功' => '手勢密碼添加成功',
    '取消手势密码成功' => '取消手勢密碼成功',
    '密码只能在6-16位之间' => '密碼必須在6至16位之間',
    '交易密码设置成功' => '交易密碼設置成功',
    '暂时还没有邀请排行榜，快去邀请吧' => '暫時還沒有邀請排行榜，快去邀請吧',
    '会员未找到' => '未找到會員',
    '你已绑定，不可更改!' => '您已經綁定，不能更改！',
    '该地址已被绑定,请重新输入' => '該地址已被綁定，請重新輸入',
    '绑定成功!' => '綁定成功！',
    '请提交完整的信息' => '請提交完整的信息',
    '请输入合法的身份证号码' => '請輸入合法的身份證號碼',
    '该身份证号已实名认证过!' => '該身份證號碼已經進行了實名認證！',
    '您已经申请过了' => '您已經申請過了',
    '提交成功，等待审核' => '提交成功，等待審核',
    '您还没有交易记录' => '您還沒有交易記錄',
    '非法操作,不能撤回非自己发布的信息' => '非法操作，不能撤回非自己發佈的信息',
    '非法操作:(' => '非法操作:(',
    '取销卖出交易失败' => '取消賣出交易失敗',
    '取消成功' => '取消成功',
    '非法操作' => '非法操作',
    ...
    '请填写手机号' => '請填寫手機號',
    '参数不全' => '參數不完整',
    '服务器空间不支持,请确认支持curl或者fsocket，联系您的空间商解决或者更换空间！' => '服務器空間不支持，請確認支持curl或fsocket，聯繫您的空間提供商解決或更換空間！',
    '帐户已过期' => '賬戶已過期',
    'IP地址限制' => 'IP地址限制',
    '账号被禁用' => '賬號被禁用',
    '内容含有敏感词' => '內容含有敏感詞',
    ...
    '名称不能为空' => '名稱不能為空',
    '资产不能为空' => '資產不能為空',
    '找不到此交易账号的用户' => '找不到該交易賬號的用戶',
    '此用户还未通过实名认证' => '該用戶還未通過實名認證',
    '此用户已是此法币商家' => '該用戶已經是此法幣商家',
    '新闻不存在' => '新聞不存在',
    '下单失败:超过最大持仓笔数限制' => '下單失敗：超過最大持倉數限制',
    '当前未获取到行情' => '當前未獲取到行情',
    '尚未申购或理赔保险' => '尚未申購或理賠保險',
    '申购的保险T+1生效' => '申購的保險T+1生效',
    '受保资产为零' => '受保資產為零',
    '受保资产小于等于可下单条件' => '受保資產小於或等於可下單條件',
    '您已超过持仓限制，暂停下单。' => '您已超過持倉限制，暫停下單。',
    '未知的险种类型' => '未知的險種類型',
    '超过最大持仓数量限制' => '超過最大持倉數量限制',
    '交易中的订单大于最大挂单数量' => '交易中的訂單超過最大掛單數量',
    '请输入账号' => '請輸入賬號',
    '请输入密码' => '請輸入密碼',
    '手势密码错误' => '手勢密碼錯誤',
    '请填写正确的邀请码' => '請填寫正確的邀請碼',
    ...
    '选择倍数不在系统范围' => '選擇的倍數不在系統範圍內',
    '您有正在平仓中的交易,暂不能进行买卖' => '您有正在平倉中的交易，暫時不能進行買賣',
    '交易类型错误' => '交易類型錯誤',
    '该功能暂未开放' => '該功能暫未開放',
    ...
    '请填写购买额' => '請填寫購買額',
    '购买额请填写数字' => '購買額請填寫數字',
    '未完成单子超过3单，请完成后再操作!' => '未完成訂單超過3單，請完成後再操作！',
    '此条交易已完成' => '此筆交易已完成',
    ...
    '您不是此币商家' => '您不是此幣商家',
    '该订单已操作过，请勿重复操作' => '該訂單已經操作過，請勿重複操作',
    '对不起，您无权操作' => '對不起，您無權操作',
    '操作成功，请联系卖家确认' => '操作成功，請聯繫賣家確認',
    ...
    '商家不存在' => '商家不存在',
    '已撤回发布' => '已撤回發佈',
    '该发布信息下有交易产生无法删除' => '該發佈信息下有交易產生，無法刪除',
    '撤回成功' => '撤回成功',
    '该发布信息下有交易未完成，不能标记为异常' => '該發佈信息下有交易未完成，不能標記為異常',
    '该发布信息无异常' => '該發佈信息無異常',
    ...
    '超出今日索赔次数!' => '超出今日索賠次數！',
    '存在未平仓订单' => '存在未平倉訂單',
    '受保资产不符合可申请索赔条件1' => '受保資產不符合可申請索賠條件1',
    '受保资产不符合可申请索赔条件2' => '受保資產不符合可申請索賠條件2',
    ...
    '用户不存在' => '用戶不存在',
    '未找到该发布用户' => '未找到該發佈用戶',
    '检测有未完成交易，请完成后再来！' => '檢測到有未完成交易，請完成後再來！',
    '您的余额不足' => '您的餘額不足',
    '用户信息不正确' => '用戶信息不正確',
    '对不起，这不是您的发布信息' => '對不起，這不是您的發佈信息',
    ...
    '项目不存在' => '項目不存在',
    '最少存入数量为：' => '最少存入數量為：',
    '当前等级禁止购买30S产品，请联系客服升级' => '當前等級禁止購買30S產品，請聯繫客服升級',
    '请登录' => '請登錄',
    '毁约成功' => '解約成功',
    '旧密码错误' => '舊密碼錯誤',
    '您的实名认证未通过' => '您的實名認證未通過',
    ...
    '最小下单数量不能小于' => '最小下單數量不能小於',
    '申请成功' => '申請成功',
    '认证成功，请等待审核' => '認證成功，請等待審核',
    '操作失败:您的信用分不足' => '操作失敗：您的信用分不足',
    '操作失败:您有未平仓的交易,操作禁止' => '操作失敗：您有未平倉的交易，禁止操作',
